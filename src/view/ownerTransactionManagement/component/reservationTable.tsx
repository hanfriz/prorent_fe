  ...
  return (
    <div className="space-y-4">
      ...
      <div className="hidden md:block border rounded-2xl bg-white shadow-pr-soft">
        ...
        {pagination && (
          <div className="flex items-center justify-between p-4 border-t bg-pr-bg">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="text-sm text-pr-dark">
...
export default OwnerReservationTable;
